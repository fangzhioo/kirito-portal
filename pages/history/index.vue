        ...
        <v-col cols="12" sm="12" order="2" order-sm="2" order-md="1" order-lg="1" md="7" lg="7" class="pt-8 pl-8">
                    ...
                    <v-col>
                      <div class="ml-2">
                        ...
                        <v-card-subtitle class="pl-2 pt-2 pb-0" style="line-height: 1;">
                          Tech Reagan<v-icon>mdi-circle-small</v-icon>9.6k views
                        </v-card-subtitle>
                        <v-card-subtitle class="pl-2 pt-2 pb-0">
                          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat consequatur rerum id nulla,
                          iure beatae atque
                        </v-card-subtitle>
                      </div>
                    </v-col>
          ...
          <template v-else>
            <div v-for="i in 10" :key="i">
              <v-skeleton-loader class="mx-auto" type="list-item-two-line" :loading="searchTextsLoading" tile large>
                <v-card class="card d-flex pl-0" flat>
                  <v-card-text class="pl-0 py-0">
                    ...
                    >
                    <v-card-subtitle class="pl-0 pb-0">18 hours ago</v-card-subtitle>
                  </v-card-text>
                  <v-card-actions
...
export default {
  data: () => ({
    ...
    items: ['Watch History', 'Search History', 'Community', 'Comments', 'Live Chat'],
